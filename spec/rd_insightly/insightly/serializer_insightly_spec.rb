  ...
  describe SerializerInsightly do
    ...
    context '#lead_to_hash' do
      context 'should return hash Insightly of lead with all fields' do
        let(:lead_hash) { SerializerInsightly.lead_to_hash(Lead.new LAST_NAME, name: NAME, email: EMAIL, company: COMPANY, job_title: JOB_TITLE, phone: PHONE, website: WEBSITE) }
